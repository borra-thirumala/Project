...
function addOptionsToSelect(array, selectElement) {
    ...
    document.addEventListener("DOMContentLoaded",()=>{
        const selectElements = document.getElementsByClassName("symptomsSelect");
        for(let i=0;i<selectElements.length;i++) {
          addOptionsToSelect(symptomsArray.sort(), selectElements.item(i))
        }
